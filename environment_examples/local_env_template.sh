...
export SKELETONCACHE_VERSION=0.1.50
...
export GUIDEBOOK_WORKER_MAX_REPLICAS=1

export TOURGUIDE_MIN_REPLICAS=1
export TOURGUIDE_MAX_REPLICAS=1
...
export LIMITS_SKELETON_REQUESTS_PER_MINUTE=100
export SK_LIMITER_CATEGORIES={\"request\":\"${LIMITS_SKELETON_REQUESTS_PER_MINUTE}/minute\"}
