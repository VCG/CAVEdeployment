...
export SKELETON_CACHE_DEAD_LETTER_EXCHANGE="${ENVIRONMENT}_SKELETON_CACHE_DEAD_LETTER"
export SKELETON_CACHE_DEAD_LETTER_RETRIEVE_QUEUE="${ENVIRONMENT}_SKELETON_CACHE_DEAD_LETTER_RETRIEVE"
