...
kubectl create secret generic $SKELETON_SERVICE_ACCOUNT_SECRET --from-file=${GOOGLE_SECRET_FILENAME}=${KEY_FOLDER}/${SKELETON_SERVICE_ACCOUNT_NAME}.json $SKELETON_SERVICE_ACCOUNT_ADDON \
    --from-file=${CAVE_SECRET_FILENAME}=${ADD_STORAGE_SECRET_FOLDER}/${CAVE_SECRET_FILENAME} 
